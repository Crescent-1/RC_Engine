...
class QuestionEngine:
    ...
    def build(self, bp: Blueprint, passage: str, ledger: CostLedger,
        ...
        stage: config STAGE_CONFIG key (use 'length_fix' for cheap Sonnet rewrite)."""
        ...
        last_err = None
        attempts = (config.MAX_LENGTH_FIX_ATTEMPTS if stage == "length_fix"
                    else config.MAX_QUESTION_ATTEMPTS)
